...
class PostRequest:
    ...
    # ---- USER INTENT ----
    user_key_message: str = ""      # The specific message/insight user wants to share
    tags_people: List[str] = field(default_factory=list)           # LinkedIn handles to tag (people)
    tags_organizations: List[str] = field(default_factory=list)    # LinkedIn handles to tag (orgs)
