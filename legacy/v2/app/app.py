...
class LinkedInPostApp:
    ...
    def _render_main_content(self):
        ...
        # Input section
        github_url, topic, text_input, user_key_message = UIComponents.render_input_section(mode)

        # Tagging section
        tags_people, tags_organizations = UIComponents.render_tagging_section()
        ...
        if UIComponents.render_generate_button():
            self._handle_generation(
                ...
                user_key_message=user_key_message,
                tags_people=tags_people,
                tags_organizations=tags_organizations,
                tone=tone,
                audience=audience,
    ...
    def _handle_generation(
        ...
        topic: str,
        text_input: str,
        user_key_message: str,
        tags_people: list,
        tags_organizations: list,
        tone: Tone,
        audience: Audience,
